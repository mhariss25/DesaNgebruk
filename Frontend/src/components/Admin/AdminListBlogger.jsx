...
const AdminsListBlogger = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      console.log("Fetching data:", { currentPage, searchQuery });
      try {
        const response = await axios.get(
          `http://localhost:8080/api-blog-ngebruk/blogger?page=${currentPage}&pageSize=${pageSize}&search=${encodeURIComponent(
            searchQuery
          )}`
        );
  ...
  }, [currentPage, fetchStatus, searchQuery]);
  ...
  const handleEdit = (id) => {
    navigate(`/blogger/update_blogger/${id}`);
  };
      ...
      <div className="h-full">
        <div className="p-4 mt-20">
          ...
          <div className="mt-2">
            ...
            <div className="p-4">
              <button
                onClick={() => navigate("/blogger/create_blogger")}
                type="button"
...
export default AdminsListBlogger;
